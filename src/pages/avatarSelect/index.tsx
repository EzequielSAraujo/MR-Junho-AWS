...
const AvatarSelectionScreen: React.FC = () => {
  ...
  const avatars: Avatar[] = [
    { id: 1, imageUrl: 'https://img-teskly.s3.us-east-2.amazonaws.com/img/Ellipse%201.png', borderColor: '#5B3CC4' },
    { id: 2, imageUrl: 'https://img-teskly.s3.us-east-2.amazonaws.com/img/Ellipse%202.png', borderColor: '#E6E0F7' },
    { id: 3, imageUrl: 'https://img-teskly.s3.us-east-2.amazonaws.com/img/Ellipse%203.png', borderColor: '#32C25B' },
    { id: 4, imageUrl: 'https://img-teskly.s3.us-east-2.amazonaws.com/img/Ellipse%204.png', borderColor: '#E63946' },
